...
def prepare_data(dataset_root='dataset', output_dir='coco', train_split=0.8, seed=42):
    ...
    for split, split_basenames, folder in [('train', train_basenames, 'train2017'), ('val', val_basenames, 'val2017')]:
        ...
        for image_id, basename in enumerate(split_basenames, start=1):
            ...
            img_file_candidates = [f for f in os.listdir(source_dir) if os.path.splitext(f)[0] == basename and f.lower().endswith(img_extensions)]
            ...
            if is_positive:
                ...
                mask_file_candidates = [f for f in os.listdir(masks_dir) if os.path.splitext(f)[0] == basename and f.lower().endswith(mask_extensions)]
